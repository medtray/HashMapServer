...
CXX      = g++
LD       = g++
CXXFLAGS = -MMD -O0 -m$(BITS) -ggdb -std=c++17 -lpthread -L /usr/local/tbb -ltbb -lv8 -lboost_filesystem -lboost_system
LDFLAGS  = -m$(BITS) -lm -lpthread -L /usr/local/tbb -ltbb -lv8 -lboost_filesystem -lboost_system 
